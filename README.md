...
Construyo productos digitales con foco en datos, automatización y crecimiento orgánico.  
Me muevo cómodo entre backend, producto y SEO técnico, y me gusta resolver problemas reales con código.

He trabajado tanto en entornos de **Big Data** como creando y operando **productos propios**, así que suelo pensar las cosas de punta a punta: arquitectura, uso real, escalabilidad y mantenimiento.

---

### 🔭 Ahora mismo estoy trabajando en
- Una plataforma **multi-tenant** orientada a publicar directorios de nicho y SEO con NodeJS y ReactJS
- Motores de **ingestión y enriquecimiento de datos** (ETL, crawlers, scrapers) en NodeJS
- Desarrollo **config-first**
...
- Automatización y tooling para escalar sin añadir complejidad
- Mejora de DX con IA
...
- Proyectos pequeños que resuelven problemas concretos 
- Productos donde ingeniería y negocio van de la mano
...
- Uso realista de IA en desarrollo (sin prompts mágicos ni `vibe coding`)
...
- LinkedIn: [linkedin.com/in/rodrigo-de-miguel-gonzalez](https://linkedin.com/in/rodrigo-de-miguel-gonzalez)

---

### ⚡ Dato curioso
Si un problema se repite más de dos veces, probablemente acabe convirtiéndolo en un script... 
aunque luego tenga que ordenar backups de hace 10 años 😅
...
<a href="https://linkedin.com/in/rodrigo-de-miguel-gonzalez" target="blank"><img align="center" src="https://raw.githubusercontent.com/rahuldkjain/github-profile-readme-generator/master/src/images/icons/Social/linked-in-alt.svg" alt="rodrigo-de-miguel-gonzalez" height="30" width="40" /></a>
